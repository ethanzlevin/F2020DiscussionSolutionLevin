...
namespace F2020DiscussionAppLevin.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel //view model for registering users
        {
            [Required]
            ...
            public int NumberOfVolunteerHours { get; set; }
        }
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    user = new Volunteer(Input.Firstname, Input.Lastname, Input.Address, Input.Phone, Input.Email, Input.Password, Input.NumberOfVolunteerHours);
